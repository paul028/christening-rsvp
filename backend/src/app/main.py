...
from src.app.api.guest_routes import router as guest_router, event_router, init_guest_routes
...
def _create_app() -> FastAPI:
    ...
    init_guest_routes(guest_service)
    init_admin_routes(guest_service)
